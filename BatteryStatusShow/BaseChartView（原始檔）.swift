...
class BaseChartView:NSView{
    ...
    func maxminlabelinit()->Bool{
        if (showmaxmin){
            ...
            if (minnum == nil || maxnum == nil){
                ...
                minnum.backgroundColor = NSColor.controlColor
                ...
                maxnum.backgroundColor = NSColor.controlColor
    ...
    func setdefault(){
        ...
        title.backgroundColor = NSColor.controlColor
        ...
        xtitle.backgroundColor = NSColor.controlColor
        ...
        ytitle.backgroundColor = NSColor.controlColor
        ...
        for i in 0...3 {
            ...
            column.backgroundColor = NSColor.controlColor
    ...
    func buildchat(_ context:CGContext,_ dirtyRect: NSRect){
        ...
        for i in 0...3 {
            ...
            let rowinterval  = NSPoint(x:xoffset/2 - rowlabel[i].fittingSize.width / 2 + offsetx,
